...
<div class="container-fluid px-4">
    <h1 class="mt-4"><?= __('edit_customer') ?></h1>
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active"><?= __('edit_customer') ?></li>
    </ol>
    ...
    <div class="card mb-4">
        <div class="card-header">
            ...
            <?= __('edit_customer_information') ?>
        </div>
        <div class="card-body">
            <form action="index.php?page=customer&action=edit&id=<?= $customer['id'] ?>" method="post" class="needs-validation" novalidate>
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="code" name="code" value="<?= htmlspecialchars($customer['code'] ?? '') ?>">
                ...
                <div class="d-flex justify-content-end mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save me-1"></i> <?= __('update_customer') ?>
                    </button>
                </div>
            </form>
        </div>
